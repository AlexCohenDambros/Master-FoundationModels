...
from setup.datasets.moe_dataset import MoEDataset
from setup.datasets.moe_window_dataset import MoEWindowDataset
from setup.models.modeling_foundation_moe import MoeForPrediction, FoundationMoEConfig
from setup.trainer.hf_trainer import MoETrainingArguments, MoeTrainer
from setup.utils.dist_util import get_world_size
from setup.utils.log_util import logger, log_in_local_rank_0
...
class MoeRunner:
    ...
    def train_model(self, from_scratch: bool = False, **kwargs):
        ...
        training_args = MoETrainingArguments(
    ...
    def get_train_dataset(self, data_path, max_length, stride, normalization_method):
        ...
        dataset = MoEDataset(data_path, normalization_method=normalization_method)
        log_in_local_rank_0('Processing dataset to fixed-size sub-sequences...')
        window_dataset = MoEWindowDataset(dataset, context_length=max_length, prediction_length=0, stride=stride, shuffle=False)

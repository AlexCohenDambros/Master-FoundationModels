...
# MAIN PIPELINE
# ======================================
def run_full_experiment_pipeline(experiment_name: str, path_trained_models: str = "trained_models", top_k:int = 2, use_noise = True, n_cores: int = 3, norm: str = "std"):
    ...
    def process_dataset(state_code, year, context_length, prediction_length):
        ...
        #     model = NBEATSModel(
        #     input_chunk_length=context_length - prediction_length,
...
if __name__ == "__main__":
    ...
    run_full_experiment_pipeline(
        experiment_name="novos_models",
        path_trained_models="trained_models/novos_models",
        top_k=2,
        use_noise=True,
        norm="std",
    )